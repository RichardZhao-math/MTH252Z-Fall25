...
},
{
  ...
  "number": "",
  "title": "",
  "body": "  After this section, students will be able to:     evaluate trigonometric integrals involving sine, cosine, and their powers.    summarize a list of formulas involving trigonometric functions for .    "
},
{
  "id": "subsec-722IntermediateTrigIntegral-5-2-2",
  "level": "2",
  "url": "sec72-TrigIntegral.html#subsec-722IntermediateTrigIntegral-5-2-2",
  "type": "Table",
  "number": "7.2.1",
  "title": "",
...
},
{
  ...
  "body": " Trigonometric Substitution   In this section, we will learn another substitution method to evaluate integrals, called the Trigonometric Substitution .    After this section, students will be able to:     identify the correct case for the trig substitution    perform a trig substitution to convert the integral to a trigonometric integral    evaluate the trigonometric integral using formulas\/strategies in         Let's do a quick review on right triangles and basic trigonometry. There are three right triangles below. We know about a non-right angle and two sides, and . Your task is to   find the missing side of the right triangle, and    set up a trigonometric ratio using , , and .        Right Triangle Case I       Observe that the missing side is and .      Right Triangle Case II       Observe that the missing side is and .      Right Triangle Case III       Observe that the missing side is and .     You may be wondering what all of them have to do with integrals... These three right triangles are the three base cases of trigonometric substitution .   Trigonometric substitution (or trig sub for short), means we are making substitutions using trigonometric functions. Recall a goal of the substitution method back in section 5.7 when we learned the -sub is to make the integral easier . An advantage of trig sub here is that we can convert an un-simplified-able expression to a trigonometric expression, and we can manipulate it using trigonometric identities.   Integrals Involving  When you see an \" \" in the integral, you may be able to solve it using a trig sub. The should remind you of the first right triangle in the investigation task because the missing side of the triangle is .   Evaluate the indefinite integral    Observe that we can't simplify the integrand here, and there is no integral formulas we learned before that has a similar form of the integrand (not even the formulas involving inverse trig functions).  You can try making a -sub, but Richard can tell you right now that there is no choice of that will work out.  You may also be considering using integration by parts. But this involves turning the fraction into a product and it seems complicated to work out all the 's and 's... You can for sure give it a go but Richard has a feeling that this will be complicated...  Hmm... but is there an easier way to tackle this problem...  Richard is again come to your rescue! He is going to make a suggestion! Let's try this substitution to let . What does the integral look like after we fully substitute all the 's with the 's?    Let's follow Richard's hint and make the substitution that . Then this will imply that and   Remember we also want to convert the to something with a . Observe that   Now it looks like all the 's have been converted to 's. Let's plug them back into the integral and see whether the integral will become easier. Observe how much easier-looking the integral became after this substitution! We no longer have fractions and square roots! All we had here is a .  You can actually find a formula to evaluate in (more specifically, in ).  Now using the formula, we have   The last step here is to plug back whatever is in terms of . There are actually a trivial way and a technical way to do so.   Trivial Way: Recall the substitution we made is . Isolating will give us . Hence, we can plug in the for . But look at how messy the answer is... You can for sure simplify this scary-looking answer using the technical way.   P.S.: If all you care about is to obtain a correct answer, however messy it is, put it to Edfinity, and move on, Richard is 80% sure that Edfinity will recognize answers like this if it is correct.   Technical Way: We know . There is no way to make it easier. But we can do something fun to plug things in for the ! By the double angle identity, we know that , and based on the substitution we made. Then what is in our substitution?  This is a classical MTH 112Z problem to find the cosine value given the sine value. An easier way is to literally draw a right triangle that looks like the first right triangle in the investigation task and figure out the cosine value, as the figure below shows.   A right triangle with      Observe that . This implies that Now plugging in this back to the antiderivative, we have This answer is the simplified answer.    That was a long example, but it captures the essence of the first case of the trig sub.  If is in the integral, then try the substitution . Then and Then we can deal with a (usually) simpler trigonometric integral. Observe that the trigonometric identity that allows us to simplify stuff is   For strategies to deal with a trigonometric integral, feel free to consult .  If you are reading our textbook, this case is labeled as \"integrals involving \". The reason why your textbook throw in the square root is because dealing with powers of sine (and cosine) isn't quite easy. But this will have no impact on the determination of using trig sub itself. So the square root may make the trigonometric integral easier after the trig sub, but the trig sub will work without the square root.  Let's look at an example of the definite integrals using a trig sub. Recall back in section 5.7 that we need to adjust the limits of integration when doing a -sub since we changed the variable. Similarly, trig sub is essentially a substitution method in the sense that we use a new variable . So make sure you adjust the limits of integration when doing a trig sub!    Evaluate the definite integral    Observe that the integral contain , which takes the form of , where . Then what trig sub should we do here?  In addition, this in a definite integral. Given that we are essentially changing the variable from to , we will need to adjust the limits of integration !    Let . Then we know that , and    Remember we also need to adjust the limits of integration!!    When , then , which implies that ;    When , then , which implies that .     Now let's plug everything back to the integral and see if the integral becomes easier.   Observe that this trig integral does look easier than what we started. is the section about integrating trig integrals so you may be able to find some clues there to evaluate this integral. It turns out that one of the integral formulas we learned back in when we un-did the derivative formulas in calculus 1 is useful (see ).         Integrals Involving  When you see an \" \" in the integral, you may also be able to solve it using a trig sub. The should remind you of the second right triangle in the investigation task because the missing side of the triangle is .   Evaluate the indefinite integral    Similarly, there is no way to simplify this integral. Also, -sub and integration by parts won't work either.  Richard is feeling generous and he is providing another suggestion! Let's try the substitution to let . Does the integral become easier-looking after we fully substitute all the 's with the 's?    Let's again follow Richard's hint and make the substitution that . Then this implies that and   Remember we also want to convert the to something with a . Observe that   Now it looks like all the 's have been converted to 's. Let's plug them back into the integral and see whether the integral will become easier. Hmm... it seems like the integral still looks complicated. But a good thing with trig is that we can convert everything into sine and cosine!   Now this integral is definitely u-sub-able! The strategy is similar to the integral of tangent and cotangent in (more specifically, in ).  Let . Then . This implies that   Now that we found the antiderivative, we will need to plug back whatever is in terms of . Again, there is the trivial way and the technical way to do so (and this is really about simplification so we don't end up getting an inverse trig function inside a trig function).   Trivial Way: Recall the substitution we made is . Isolating will give us . Hence, we can plug in the for . But the answer is really messy mainly because there is an inverse trig function inside a trig function. It seems like we may be able to simplify the answer.   Technical Way: We can do the same trick of constructing a right triangle (the right triangle should look like the second right triangle in the investigation task) and figure out what the value is, as the figure below shows.   A right triangle with      Observe that . Now plugging this back to the antiderivative, we have     This was also a long example, but it again captures the essence of the second case of the trig sub.  If is in the integral, then try the substitution . Then and Then we can deal with a (usually) simpler trigonometric integral. Observe that the trigonometric identity that allows us to simplify stuff is   For strategies to deal with a trigonometric integral, feel free to consult .  If you are reading our textbook, this case is labeled as \"integrals involving \". This is similar to the first case of the trig sub that having a square root will just make the trig integral we get after the trig sub to be easier (and half of the time, it actually doesn't), but the square root should have no impact on the determination of using trig sub.    Integrals Involving  By now, you may get the idea that we may be able to make a trig sub to deal with the integrals involving . The answer is yes! This will be the third case of the trig sub.  If is in the integral, then try the substitution . Then and Then we can deal with a (usually) simpler trigonometric integral. Observe that the trigonometric identity that allows us to simplify stuff is    Evaluate the definite integral    Observe that there is no in the integral... But there has to be a in the integral (or why Richard put this problem as an example here)...  This is an algebraic trick you will need for an Edfinity problem. To force out some squares in the integrand, you may consider doing a completing the square on the trinomial.  If the method of completing the square sounds familiar but you don't remember much of it, Google it or ask Richard (he has a very pretty diagram about it when he teaches this in MTH 95 at PCC).    Using the method of completing the square on the trinomial inside the square root, we obtain Then we can rewrite the problem as follows:   Observe that now we are observing a in the integrand if and . This implies a small little -sub (or -sub) to match the format of this case using trig sub.   Now this integral looks like something we can do a trig sub on! Let . Then and   Also, since we changed the variable from to , we will need to adjust the limits of integration.    When , then , which implies that ;    When , then , which implies that .     Now let's plug everything back to the integral and see if the integral becomes easier. The integral is definitely easier and we can evaluate it using the Pythagorean Identity.       Some Exercises for this section   I included some practice problems that cover some main concepts in this section. You don't need to turn it in, but I highly encourage you to work on this with your classmates. I may take problems here to be your in-class practice problems, homework problems, and\/or exam problems. Reach out to Richard for help if you get stuck or have any questions.  I will only include the final answer to some of the problems for you to check your result. If you want to check your work, talk to Richard and he is happy to discuss the process with you.     Evaluate the following integrals                                         Evaluate the following integral by first using a -sub.                    Evaluate the integral . You will need to find a good strategy to evaluate the trigonometric integral in .     "
},
{
  "id": "sec73-TrigSub-2-2",
  "level": "2",
  "url": "sec73-TrigSub.html#sec73-TrigSub-2-2",
  "type": "Objectives",
  "number": "",
  "title": "",
  "body": "  After this section, students will be able to:     identify the correct case for the trig substitution    perform a trig substitution to convert the integral to a trigonometric integral    evaluate the trigonometric integral using formulas\/strategies in     "
},
{
  "id": "sec73-TrigSub-3",
  "level": "2",
  "url": "sec73-TrigSub.html#sec73-TrigSub-3",
  "type": "Investigation",
  "number": "7.3.1",
  "title": "",
  "body": "  Let's do a quick review on right triangles and basic trigonometry. There are three right triangles below. We know about a non-right angle and two sides, and . Your task is to   find the missing side of the right triangle, and    set up a trigonometric ratio using , , and .        Right Triangle Case I       Observe that the missing side is and .      Right Triangle Case II       Observe that the missing side is and .      Right Triangle Case III       Observe that the missing side is and .    "
},
{
  "id": "subsec-731-TrigSub_Sine-3",
  "level": "2",
  "url": "sec73-TrigSub.html#subsec-731-TrigSub_Sine-3",
  "type": "Example",
  "number": "7.3.4",
  "title": "",
...
{
  "id": "subsec-731-TrigSub_Sine-9",
  "level": "2",
  "url": "sec73-TrigSub.html#subsec-731-TrigSub_Sine-9",
  "type": "Example",
  "number": "7.3.6",
  "title": "",
  "body": " Evaluate the definite integral    Observe that the integral contain , which takes the form of , where . Then what trig sub should we do here?  In addition, this in a definite integral. Given that we are essentially changing the variable from to , we will need to adjust the limits of integration !    Let . Then we know that , and    Remember we also need to adjust the limits of integration!!    When , then , which implies that ;    When , then , which implies that .     Now let's plug everything back to the integral and see if the integral becomes easier.   Observe that this trig integral does look easier than what we started. is the section about integrating trig integrals so you may be able to find some clues there to evaluate this integral. It turns out that one of the integral formulas we learned back in when we un-did the derivative formulas in calculus 1 is useful (see ).      "
},
{
  "id": "subsec-732-TrigSub_Tangent-3",
  "level": "2",
  "url": "sec73-TrigSub.html#subsec-732-TrigSub_Tangent-3",
  "type": "Example",
  "number": "7.3.7",
  "title": "",
  "body": " Evaluate the indefinite integral    Similarly, there is no way to simplify this integral. Also, -sub and integration by parts won't work either.  Richard is feeling generous and he is providing another suggestion! Let's try the substitution to let . Does the integral become easier-looking after we fully substitute all the 's with the 's?    Let's again follow Richard's hint and make the substitution that . Then this implies that and   Remember we also want to convert the to something with a . Observe that   Now it looks like all the 's have been converted to 's. Let's plug them back into the integral and see whether the integral will become easier. Hmm... it seems like the integral still looks complicated. But a good thing with trig is that we can convert everything into sine and cosine!   Now this integral is definitely u-sub-able! The strategy is similar to the integral of tangent and cotangent in (more specifically, in ).  Let . Then . This implies that   Now that we found the antiderivative, we will need to plug back whatever is in terms of . Again, there is the trivial way and the technical way to do so (and this is really about simplification so we don't end up getting an inverse trig function inside a trig function).   Trivial Way: Recall the substitution we made is . Isolating will give us . Hence, we can plug in the for . But the answer is really messy mainly because there is an inverse trig function inside a trig function. It seems like we may be able to simplify the answer.   Technical Way: We can do the same trick of constructing a right triangle (the right triangle should look like the second right triangle in the investigation task) and figure out what the value is, as the figure below shows.   A right triangle with      Observe that . Now plugging this back to the antiderivative, we have    "
...
{
  "id": "subsec-733-TrigSub_Secant-4",
  "level": "2",
  "url": "sec73-TrigSub.html#subsec-733-TrigSub_Secant-4",
  "type": "Example",
  "number": "7.3.9",
  "title": "",
  "body": " Evaluate the definite integral    Observe that there is no in the integral... But there has to be a in the integral (or why Richard put this problem as an example here)...  This is an algebraic trick you will need for an Edfinity problem. To force out some squares in the integrand, you may consider doing a completing the square on the trinomial.  If the method of completing the square sounds familiar but you don't remember much of it, Google it or ask Richard (he has a very pretty diagram about it when he teaches this in MTH 95 at PCC).    Using the method of completing the square on the trinomial inside the square root, we obtain Then we can rewrite the problem as follows:   Observe that now we are observing a in the integrand if and . This implies a small little -sub (or -sub) to match the format of this case using trig sub.   Now this integral looks like something we can do a trig sub on! Let . Then and   Also, since we changed the variable from to , we will need to adjust the limits of integration.    When , then , which implies that ;    When , then , which implies that .     Now let's plug everything back to the integral and see if the integral becomes easier. The integral is definitely easier and we can evaluate it using the Pythagorean Identity.    "
},
{
  "id": "ws-sec73-3-2",
  "level": "2",
  "url": "sec73-TrigSub.html#ws-sec73-3-2",
  "type": "Worksheet Exercise",
  "number": "1",
  "title": "",
  "body": "      "
},
{
  "id": "ws-sec73-3-3",
  "level": "2",
  "url": "sec73-TrigSub.html#ws-sec73-3-3",
  "type": "Worksheet Exercise",
  "number": "2",
  "title": "",
  "body": "      "
},
{
  "id": "ws-sec73-3-4",
  "level": "2",
  "url": "sec73-TrigSub.html#ws-sec73-3-4",
  "type": "Worksheet Exercise",
  "number": "3",
  "title": "",
  "body": "      "
},
{
  "id": "ws-sec73-3-5",
  "level": "2",
  "url": "sec73-TrigSub.html#ws-sec73-3-5",
  "type": "Worksheet Exercise",
  "number": "4",
  "title": "",
  "body": "      "
},
{
  "id": "ws-sec73-3-6",
  "level": "2",
  "url": "sec73-TrigSub.html#ws-sec73-3-6",
  "type": "Worksheet Exercise",
  "number": "5",
  "title": "",
  "body": "      "
},
{
  "id": "ws-sec73-4-2",
  "level": "2",
  "url": "sec73-TrigSub.html#ws-sec73-4-2",
  "type": "Worksheet Exercise",
  "number": "6",
  "title": "",
  "body": "      "
},
{
  "id": "ws-sec73-4-3",
  "level": "2",
  "url": "sec73-TrigSub.html#ws-sec73-4-3",
  "type": "Worksheet Exercise",
  "number": "7",
  "title": "",
  "body": "      "
},
{
  "id": "ws-sec73-5",
  "level": "2",
  "url": "sec73-TrigSub.html#ws-sec73-5",
  "type": "Worksheet Exercise",
  "number": "8",
  "title": "",
...
},
{
  ...
  "number": "7.6.1",
  "title": "POP QUIZ!",
  "body": " POP QUIZ!   Suppose the following question were the first problem on your final exam for this class.  Evaluate the integral     We can evaluate this integral using the three methods we have learned in his class: -sub, trig sub, and partial fraction decomposition.   Using -sub  Let . Then . Hence, we obtain     Using Trig sub  Let . Then . Hence, we obtain where .    Using Partial Fraction Decomposition  Let and be two numbers. Note that This implies that We can determine that and . Hence, we obtain     "
},
{
